...
urlpatterns = [
    ...
    path('publication_authors/<int:publication_id>/', views.authors_view, name='publication_authors'),
    path('publication_authors/<int:publication_id>/<str:category>', views.authors_view, name='publication_authors'),
    path('publication_authors/<int:publication_id>/<str:category>/<str:scoring>', views.authors_view, name='publication_authors'),
    path('authors/<str:category>/', views.authors_view, name='category_authors'),
    path('authors/<str:category>/<str:scoring>', views.authors_view, name='category_authors'),
