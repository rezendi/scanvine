# Generated by Django 3.0.5 on 2020-05-02 04:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'Created'), (1, 'Metadata Parsed'), (2, 'Publisher Associated'), (3, 'Author Associated'), (-1, 'Publication Parse Error'), (-2, 'Metadata Parse Error'), (-3, 'Author Not Found')], db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(0, 'Launched'), (1, 'Completed'), (-1, 'Error')], db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(0, 'Created'), (1, 'Listed')], db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.IntegerField(choices=[(0, 'Created'), (1, 'Article Associated'), (2, 'Sentiment Calculated'), (3, 'Credibility Allocated'), (4, 'Aggregates Updated'), (-1, 'Fetch Error'), (-2, 'Article Error')], db_index=True)),
                ('twitter_id', models.BigIntegerField(db_index=True, null=True)),
